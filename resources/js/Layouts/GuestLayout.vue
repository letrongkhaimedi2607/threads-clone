...
<template>
    ...
    >
        <div class="w-full flex justify-around items-center p-3">
            <Link href="/threads">
                <ApplicationLogo class="w-20 h-20 fill-current text-gray-500" />
            </Link>
            <div class="flex gap-[2.25rem]">
                <Link
                    class="hover:bg-gray-300 rounded p-3"
                    href="/threads"
                >
                    <svg
                ...
                <Link class="hover:bg-gray-300 rounded p-3" href="/new">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <Link class="hover:bg-gray-300 rounded p-3" href="/profile">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
